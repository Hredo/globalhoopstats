...
export function buildSystemPrompt(input: GenerateAdvisorInput): string {
  ...
  return [
    ...
    ``,
    `## Output`,
    `Write your entire answer in ${language}, including every section heading and label. Use clean Markdown, roughly 250-450 words for a full answer (much shorter for follow-ups). Adapt the shape to the actual question rather than forcing a fixed template. As a guide:`,
