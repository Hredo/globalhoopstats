  ...
  return (
    <>
      {banners.map((a) => (
        <div
          key={a.id}
          className="animate-nav-rise border-b border-brand-500/30 bg-gradient-to-r from-brand-500/20 via-brand-500/10 to-ember-500/10"
          role="status"
        >
      ...
      {modal ? (
        <div
          className="fixed inset-0 z-[150] flex items-center justify-center bg-black/70 p-4 backdrop-blur-sm animate-overlay-in"
        ...
        >
          <div
            className="relative w-full max-w-lg animate-modal-in overflow-hidden rounded-2xl border border-white/15 bg-surface-1 shadow-2xl"
