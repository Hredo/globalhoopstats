...
export function EmailSubscribe({ compact }: { compact?: boolean }) {
  ...
  if (compact) return <div className="mx-auto max-w-7xl px-4 sm:px-6">{inner}</div>
  ...
  return (
    <section className="full-bleed relative py-20 sm:py-28">
      ...
      />
      <div className="mx-auto max-w-7xl px-4 sm:px-6">{inner}</div>
    </section>
  )
}
